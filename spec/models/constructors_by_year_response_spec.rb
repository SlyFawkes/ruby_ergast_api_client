...
# Unit tests for SwaggerClient::ConstructorsByYearResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConstructorsByYearResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::ConstructorsByYearResponse.new
  end
  ...
  describe 'test an instance of ConstructorsByYearResponse' do
    it 'should create an instance of ConstructorsByYearResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::ConstructorsByYearResponse)
    end
  end
