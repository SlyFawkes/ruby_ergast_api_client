...
# Unit tests for SwaggerClient::CircuitLocation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CircuitLocation' do
  before do
    # run before each test
    @instance = SwaggerClient::CircuitLocation.new
  end
  ...
  describe 'test an instance of CircuitLocation' do
    it 'should create an instance of CircuitLocation' do
      expect(@instance).to be_instance_of(SwaggerClient::CircuitLocation)
    end
  end
