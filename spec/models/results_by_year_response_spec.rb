...
# Unit tests for SwaggerClient::ResultsByYearResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResultsByYearResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::ResultsByYearResponse.new
  end
  ...
  describe 'test an instance of ResultsByYearResponse' do
    it 'should create an instance of ResultsByYearResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::ResultsByYearResponse)
    end
  end
