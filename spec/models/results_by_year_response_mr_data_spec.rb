...
# Unit tests for SwaggerClient::ResultsByYearResponseMRData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResultsByYearResponseMRData' do
  before do
    # run before each test
    @instance = SwaggerClient::ResultsByYearResponseMRData.new
  end
  ...
  describe 'test an instance of ResultsByYearResponseMRData' do
    it 'should create an instance of ResultsByYearResponseMRData' do
      expect(@instance).to be_instance_of(SwaggerClient::ResultsByYearResponseMRData)
    end
  end
