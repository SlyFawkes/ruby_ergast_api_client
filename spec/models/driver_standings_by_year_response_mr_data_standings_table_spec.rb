...
# Unit tests for SwaggerClient::DriverStandingsByYearResponseMRDataStandingsTable
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DriverStandingsByYearResponseMRDataStandingsTable' do
  before do
    # run before each test
    @instance = SwaggerClient::DriverStandingsByYearResponseMRDataStandingsTable.new
  end
  ...
  describe 'test an instance of DriverStandingsByYearResponseMRDataStandingsTable' do
    it 'should create an instance of DriverStandingsByYearResponseMRDataStandingsTable' do
      expect(@instance).to be_instance_of(SwaggerClient::DriverStandingsByYearResponseMRDataStandingsTable)
    end
  end
