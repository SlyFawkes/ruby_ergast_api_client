...
# Unit tests for SwaggerClient::ConstructorsByYearResponseMRData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConstructorsByYearResponseMRData' do
  before do
    # run before each test
    @instance = SwaggerClient::ConstructorsByYearResponseMRData.new
  end
  ...
  describe 'test an instance of ConstructorsByYearResponseMRData' do
    it 'should create an instance of ConstructorsByYearResponseMRData' do
      expect(@instance).to be_instance_of(SwaggerClient::ConstructorsByYearResponseMRData)
    end
  end
  ...
  describe 'test attribute "constructor_table"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
