...
# Unit tests for SwaggerClient::ResultTime
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResultTime' do
  before do
    # run before each test
    @instance = SwaggerClient::ResultTime.new
  end
  ...
  describe 'test an instance of ResultTime' do
    it 'should create an instance of ResultTime' do
      expect(@instance).to be_instance_of(SwaggerClient::ResultTime)
    end
  end
