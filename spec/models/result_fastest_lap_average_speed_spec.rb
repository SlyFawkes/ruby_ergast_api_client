...
# Unit tests for SwaggerClient::ResultFastestLapAverageSpeed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResultFastestLapAverageSpeed' do
  before do
    # run before each test
    @instance = SwaggerClient::ResultFastestLapAverageSpeed.new
  end
  ...
  describe 'test an instance of ResultFastestLapAverageSpeed' do
    it 'should create an instance of ResultFastestLapAverageSpeed' do
      expect(@instance).to be_instance_of(SwaggerClient::ResultFastestLapAverageSpeed)
    end
  end
