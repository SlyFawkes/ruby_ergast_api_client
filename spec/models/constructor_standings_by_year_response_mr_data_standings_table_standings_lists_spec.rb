...
# Unit tests for SwaggerClient::ConstructorStandingsByYearResponseMRDataStandingsTableStandingsLists
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConstructorStandingsByYearResponseMRDataStandingsTableStandingsLists' do
  before do
    # run before each test
    @instance = SwaggerClient::ConstructorStandingsByYearResponseMRDataStandingsTableStandingsLists.new
  end
  ...
  describe 'test an instance of ConstructorStandingsByYearResponseMRDataStandingsTableStandingsLists' do
    it 'should create an instance of ConstructorStandingsByYearResponseMRDataStandingsTableStandingsLists' do
      expect(@instance).to be_instance_of(SwaggerClient::ConstructorStandingsByYearResponseMRDataStandingsTableStandingsLists)
    end
  end
  ...
  describe 'test attribute "constructor_standings"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
