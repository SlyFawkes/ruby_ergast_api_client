...
# Unit tests for SwaggerClient::ConstructorsByYearResponseMRDataConstructorTable
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConstructorsByYearResponseMRDataConstructorTable' do
  before do
    # run before each test
    @instance = SwaggerClient::ConstructorsByYearResponseMRDataConstructorTable.new
  end
  ...
  describe 'test an instance of ConstructorsByYearResponseMRDataConstructorTable' do
    it 'should create an instance of ConstructorsByYearResponseMRDataConstructorTable' do
      expect(@instance).to be_instance_of(SwaggerClient::ConstructorsByYearResponseMRDataConstructorTable)
    end
  end
