...
# Unit tests for SwaggerClient::DriverStandingsByYearResponseMRData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DriverStandingsByYearResponseMRData' do
  before do
    # run before each test
    @instance = SwaggerClient::DriverStandingsByYearResponseMRData.new
  end
  ...
  describe 'test an instance of DriverStandingsByYearResponseMRData' do
    it 'should create an instance of DriverStandingsByYearResponseMRData' do
      expect(@instance).to be_instance_of(SwaggerClient::DriverStandingsByYearResponseMRData)
    end
  end
