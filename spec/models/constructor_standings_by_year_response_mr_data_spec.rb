...
# Unit tests for SwaggerClient::ConstructorStandingsByYearResponseMRData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConstructorStandingsByYearResponseMRData' do
  before do
    # run before each test
    @instance = SwaggerClient::ConstructorStandingsByYearResponseMRData.new
  end
  ...
  describe 'test an instance of ConstructorStandingsByYearResponseMRData' do
    it 'should create an instance of ConstructorStandingsByYearResponseMRData' do
      expect(@instance).to be_instance_of(SwaggerClient::ConstructorStandingsByYearResponseMRData)
    end
  end
  ...
  describe 'test attribute "standings_table"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
