...
# Unit tests for SwaggerClient::ConstructorStandingsByYearResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConstructorStandingsByYearResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::ConstructorStandingsByYearResponse.new
  end
  ...
  describe 'test an instance of ConstructorStandingsByYearResponse' do
    it 'should create an instance of ConstructorStandingsByYearResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::ConstructorStandingsByYearResponse)
    end
  end
