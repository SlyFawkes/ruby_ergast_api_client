...
# Unit tests for SwaggerClient::SeasonByYearResponseMRDataRaceTable
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SeasonByYearResponseMRDataRaceTable' do
  before do
    # run before each test
    @instance = SwaggerClient::SeasonByYearResponseMRDataRaceTable.new
  end
  ...
  describe 'test an instance of SeasonByYearResponseMRDataRaceTable' do
    it 'should create an instance of SeasonByYearResponseMRDataRaceTable' do
      expect(@instance).to be_instance_of(SwaggerClient::SeasonByYearResponseMRDataRaceTable)
    end
  end
