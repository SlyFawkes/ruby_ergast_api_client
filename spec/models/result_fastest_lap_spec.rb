...
# Unit tests for SwaggerClient::ResultFastestLap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResultFastestLap' do
  before do
    # run before each test
    @instance = SwaggerClient::ResultFastestLap.new
  end
  ...
  describe 'test an instance of ResultFastestLap' do
    it 'should create an instance of ResultFastestLap' do
      expect(@instance).to be_instance_of(SwaggerClient::ResultFastestLap)
    end
  end
  ...
  describe 'test attribute "lap"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
