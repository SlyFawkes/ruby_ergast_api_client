...
# Unit tests for SwaggerClient::DriverStandingsByYearResponseMRDataStandingsTableDriverStandings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DriverStandingsByYearResponseMRDataStandingsTableDriverStandings' do
  before do
    # run before each test
    @instance = SwaggerClient::DriverStandingsByYearResponseMRDataStandingsTableDriverStandings.new
  end
  ...
  describe 'test an instance of DriverStandingsByYearResponseMRDataStandingsTableDriverStandings' do
    it 'should create an instance of DriverStandingsByYearResponseMRDataStandingsTableDriverStandings' do
      expect(@instance).to be_instance_of(SwaggerClient::DriverStandingsByYearResponseMRDataStandingsTableDriverStandings)
    end
  end
  ...
  describe 'test attribute "constructors"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
