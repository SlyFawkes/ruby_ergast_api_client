...
# Unit tests for SwaggerClient::ConstructorStandingsByYearResponseMRDataStandingsTableConstructorStandings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConstructorStandingsByYearResponseMRDataStandingsTableConstructorStandings' do
  before do
    # run before each test
    @instance = SwaggerClient::ConstructorStandingsByYearResponseMRDataStandingsTableConstructorStandings.new
  end
  ...
  describe 'test an instance of ConstructorStandingsByYearResponseMRDataStandingsTableConstructorStandings' do
    it 'should create an instance of ConstructorStandingsByYearResponseMRDataStandingsTableConstructorStandings' do
      expect(@instance).to be_instance_of(SwaggerClient::ConstructorStandingsByYearResponseMRDataStandingsTableConstructorStandings)
    end
  end
  ...
  describe 'test attribute "position_text"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
