...
# Unit tests for SwaggerClient::ResultFastestLapTime
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResultFastestLapTime' do
  before do
    # run before each test
    @instance = SwaggerClient::ResultFastestLapTime.new
  end
  ...
  describe 'test an instance of ResultFastestLapTime' do
    it 'should create an instance of ResultFastestLapTime' do
      expect(@instance).to be_instance_of(SwaggerClient::ResultFastestLapTime)
    end
  end
