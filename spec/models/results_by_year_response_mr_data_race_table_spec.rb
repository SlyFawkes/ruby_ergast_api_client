...
# Unit tests for SwaggerClient::ResultsByYearResponseMRDataRaceTable
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResultsByYearResponseMRDataRaceTable' do
  before do
    # run before each test
    @instance = SwaggerClient::ResultsByYearResponseMRDataRaceTable.new
  end
  ...
  describe 'test an instance of ResultsByYearResponseMRDataRaceTable' do
    it 'should create an instance of ResultsByYearResponseMRDataRaceTable' do
      expect(@instance).to be_instance_of(SwaggerClient::ResultsByYearResponseMRDataRaceTable)
    end
  end
