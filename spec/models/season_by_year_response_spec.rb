...
# Unit tests for SwaggerClient::SeasonByYearResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SeasonByYearResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::SeasonByYearResponse.new
  end
  ...
  describe 'test an instance of SeasonByYearResponse' do
    it 'should create an instance of SeasonByYearResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::SeasonByYearResponse)
    end
  end
