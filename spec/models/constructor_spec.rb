...
# Unit tests for SwaggerClient::Constructor
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Constructor' do
  before do
    # run before each test
    @instance = SwaggerClient::Constructor.new
  end
  ...
  describe 'test an instance of Constructor' do
    it 'should create an instance of Constructor' do
      expect(@instance).to be_instance_of(SwaggerClient::Constructor)
    end
  end
  describe 'test attribute "constructor_id"' do
    it 'should work' do
