...
# Unit tests for SwaggerClient::ConstructorsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConstructorsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ConstructorsApi.new
  end
  ...
  describe 'test an instance of ConstructorsApi' do
    it 'should create an instance of ConstructorsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ConstructorsApi)
    end
  end

  # unit tests for get_constructor_standings_by_year
  ...
  describe 'get_constructor_standings_by_year test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_constructors_by_year
  # @param year Year in question
  # @param [Hash] opts the optional parameters
  # @option opts [Integer] :offset The number of items to skip before starting to collect the result set.
  # @option opts [Integer] :limit The numbers of items to return.
  # @return [ConstructorsByYearResponse]
  describe 'get_constructors_by_year test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
