...
module SwaggerClient
  class ConstructorsByYearResponseMRData
    attr_accessor :xmlns
    ...
    attr_accessor :constructor_table
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ConstructorsByYearResponseMRData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ConstructorsByYearResponseMRData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'constructor_table')
        self.constructor_table = attributes[:'constructor_table']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          offset == o.offset &&
          total == o.total &&
          constructor_table == o.constructor_table
    end
    ...
    def hash
      [xmlns, series, url, limit, offset, total, constructor_table].hash
    end
