...
module SwaggerClient
  class Driver
    ...
    attr_accessor :permanent_number
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::Driver` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::Driver`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'permanent_number')
        self.permanent_number = attributes[:'permanent_number']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          permanent_number == o.permanent_number &&
          code == o.code &&
          url == o.url &&
    ...
    def hash
      [driver_id, permanent_number, code, url, given_name, family_name, date_of_birth, nationality].hash
    end
