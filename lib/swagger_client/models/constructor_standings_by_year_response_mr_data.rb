...
module SwaggerClient
  class ConstructorStandingsByYearResponseMRData
    attr_accessor :xmlns
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ConstructorStandingsByYearResponseMRData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ConstructorStandingsByYearResponseMRData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'xmlns')
        self.xmlns = attributes[:'xmlns']
      end
      ...
      if attributes.key?(:'standings_table')
        self.standings_table = attributes[:'standings_table']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          offset == o.offset &&
          total == o.total &&
          standings_table == o.standings_table
    end
    ...
    def hash
      [xmlns, series, url, limit, offset, total, standings_table].hash
    end
