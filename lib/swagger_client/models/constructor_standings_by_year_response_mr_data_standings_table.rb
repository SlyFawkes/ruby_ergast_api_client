...
module SwaggerClient
  class ConstructorStandingsByYearResponseMRDataStandingsTable
    attr_accessor :season

    attr_accessor :standings_lists

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'season' => :'season',
        :'standings_lists' => :'StandingsLists'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ConstructorStandingsByYearResponseMRDataStandingsTable` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ConstructorStandingsByYearResponseMRDataStandingsTable`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'standings_lists')
        if (value = attributes[:'standings_lists']).is_a?(Array)
          self.standings_lists = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          season == o.season &&
          standings_lists == o.standings_lists
    end
